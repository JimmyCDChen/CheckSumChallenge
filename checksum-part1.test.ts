...
import { getCheckSumPtOne } from "./checksum-part1";

describe('checksum test part 1', () => {
  it(`test case 1`, () => {
    const input1: string =
      `
    5 1 9 5
    ...
    2 4 6 8
  `;
    const result = getCheckSumPtOne(input1);
  ...
  it(`test edge case with negative input`, () => {
    const input1: string =
      `
    5 1 10 -5
    7 5 3
